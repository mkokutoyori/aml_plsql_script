...
BEGIN
    ...
    IF v_count > 0 THEN
        ...
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' CSE2',20) || '|' || LPAD(TO_CHAR(d.TOTAL_INCOME,'FM999G999G999'),19) || ' |'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,20,20,18');
    END IF;
    ...
    IF v_count > 0 THEN
        ...
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' PSE1',20) || '|' || LPAD(TO_CHAR(d.TOTAL_INCOME,'FM999G999G999'),19) || ' |'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,20,20,18');
    END IF;
    ...
    IF v_count > 0 THEN
        ...
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' PSE2',20) || '|' || LPAD(TO_CHAR(d.TOTAL_INCOME,'FM999G999G999'),19) || ' |'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,20,20,18');
    END IF;
    ...
    IF v_count > 0 THEN
        ...
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' PSE3',20) || '|' || LPAD(TO_CHAR(d.TOTAL_INCOME,'FM999G999G999'),19) || ' |'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,20,20,18');
    END IF;
    ...
    IF v_count > 0 THEN
        ...
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' PFBI',20) || '|' || LPAD(TO_CHAR(d.TOTAL_INCOME,'FM999G999G999'),19) || ' |'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,20,20,18');
    END IF;
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,22,22,22,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' COMPTE',22) || '|'
            || RPAD(' CUST_AC.FROZEN',22) || '|' || RPAD(' STTB_AC.FROZEN',22) || '|' || RPAD(' SOLDE',18) || '|');
        tbl_line('4,13,22,22,22,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,22,22,22,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' COMPTE',22) || '|'
            || RPAD(' CUST_AC.BLOCK',22) || '|' || RPAD(' STTB_AC.BLOCKED',22) || '|' || RPAD(' SOLDE',18) || '|');
        tbl_line('4,13,22,22,22,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,22,22,22,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' COMPTE',22) || '|'
            || RPAD(' CUST_AC.NO_DR',22) || '|' || RPAD(' STTB_AC.NO_DR',22) || '|' || RPAD(' SOLDE',18) || '|');
        tbl_line('4,13,22,22,22,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,28,22,22,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' CUSTOMER.COUNTRY',22) || '|' || RPAD(' KYC_R.LOCAL_ADDR_CTR',22) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,22,22,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' ' || NVL(d.country_cust,''),22) || '|' || RPAD(' ' || NVL(d.local_addr,''),22) || '|'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,22,22,18');
    END IF;
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,28,22,22,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' PERSONAL.D_COUNTRY',22) || '|' || RPAD(' KYC_R.LOCAL_ADDR_CTR',22) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,22,22,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' ' || NVL(d.d_country,''),22) || '|' || RPAD(' ' || NVL(d.local_addr,''),22) || '|'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,22,22,18');
    END IF;
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,28,22,22,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' PERSONAL.P_COUNTRY',22) || '|' || RPAD(' KYC_R.HOME_ADDR_CTR',22) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,22,22,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' ' || NVL(d.p_country,''),22) || '|' || RPAD(' ' || NVL(d.home_addr,''),22) || '|'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,22,22,18');
    END IF;
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,28,22,22,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' CUSTOMER.NATIONALITY',22) || '|' || RPAD(' CUSTOMER.CUST_CAT',22) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,22,22,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' ' || NVL(d.NATIONALITY,'-'),22) || '|' || RPAD(' ' || NVL(d.CUSTOMER_CATEGORY,'-'),22) || '|'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,22,22,18');
    END IF;
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,28,20,14,14,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' CUSTOMER.CUST_CAT',20) || '|' || RPAD(' CUST.COUNTRY',14) || '|' || RPAD(' CUST.NATNLTY',14) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,20,14,14,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' ' || NVL(d.CUSTOMER_CATEGORY,'-'),20) || '|' || RPAD(' ' || NVL(d.COUNTRY,'-'),14) || '|'
                || RPAD(' ' || NVL(d.NATIONALITY,'-'),14) || '|'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,20,14,14,18');
    END IF;
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,28,22,22,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' CUSTOMER.NATIONALITY',22) || '|' || RPAD(' CUSTOMER.COUNTRY',22) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,22,22,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' CMR',22) || '|' || RPAD(' ' || NVL(d.COUNTRY,'-'),22) || '|'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,22,22,18');
    END IF;
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,28,20,20,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' CUSTOMER.AML_REQD',20) || '|' || RPAD(' CUSTOMER.CUST_CAT',20) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,20,20,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
            SELECT c.CUSTOMER_NO, c.CUSTOMER_NAME1, c.CUSTOMER_CATEGORY,
    ...
    IF v_count > 0 THEN
        tbl_line('4,13,28,20,20,18');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' CUSTOMER.KYC_DET',20) || '|' || RPAD(' CUSTOMER.CUST_CAT',20) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,20,20,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
            SELECT c.CUSTOMER_NO, c.CUSTOMER_NAME1, c.CUSTOMER_CATEGORY,
            ...
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
                || RPAD(' ' || d.CUSTOMER_NO,13) || '|' || RPAD(' ' || SUBSTR(d.CUSTOMER_NAME1,1,26),28) || '|'
                || RPAD(' V',20) || '|' || RPAD(' ' || NVL(d.CUSTOMER_CATEGORY,'-'),20) || '|'
                || LPAD(TO_CHAR(d.total_solde,'FM999G999G999G990'),17) || ' |');
        END LOOP;
        tbl_line('4,13,28,20,20,18');
    END IF;
    ...
    IF v_count > 0 THEN
        ...
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',13) || '|' || RPAD(' NOM CLIENT',28) || '|'
            || RPAD(' KYC_R.REVIEW_DT',16) || '|' || RPAD(' RETARD (j)',12) || '|' || RPAD(' SOLDE TOTAL',18) || '|');
        tbl_line('4,13,28,16,12,18');
        v_row_num := 0;
        FOR d IN (SELECT * FROM (
    ...
    -- 7.16 Institutions religieuses (REL) : même CA+NATIONALITE mais RISK différent
    --      (uniquement clients avec comptes ouverts et actifs)
    SELECT COUNT(*) INTO v_count FROM (
        SELECT c.CUSTOMER_NO
        FROM STTM_CUSTOMER c
        JOIN STTM_KYC_MASTER m ON m.KYC_REF_NO = c.KYC_REF_NO
        LEFT JOIN STTM_KYC_CORPORATE k ON k.KYC_REF_NO = m.KYC_REF_NO
        WHERE c.CUSTOMER_CATEGORY = 'REL'
          AND EXISTS (SELECT 1 FROM STTM_CUST_ACCOUNT a WHERE a.CUST_NO = c.CUSTOMER_NO AND a.RECORD_STAT = 'O')
          AND EXISTS (
              SELECT 1 FROM STTM_CUSTOMER c2
              JOIN STTM_KYC_MASTER m2 ON m2.KYC_REF_NO = c2.KYC_REF_NO
              LEFT JOIN STTM_KYC_CORPORATE k2 ON k2.KYC_REF_NO = m2.KYC_REF_NO
              WHERE c2.CUSTOMER_CATEGORY = 'REL'
                AND c2.CUSTOMER_NO != c.CUSTOMER_NO
                AND NVL(k2.ANNUAL_TURNOVER, -1) = NVL(k.ANNUAL_TURNOVER, -1)
                AND NVL(c2.NATIONALITY, '?') = NVL(c.NATIONALITY, '?')
                AND NVL(m2.RISK_LEVEL, '?') != NVL(m.RISK_LEVEL, '?')
    ...
    print_test('REL : même CA+NATIONALITE mais RISK différent', v_count);
    IF v_count > 0 THEN
        tbl_line('4,12,22,10,8,18,6,6,16');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' CIF',12) || '|' || RPAD(' NOM CLIENT',22) || '|'
            || RPAD(' BUS_NATURE',10) || '|' || RPAD(' RISK',8) || '|' || RPAD(' ANNUAL_TURNOVER',18) || '|'
        ...
        END LOOP;
        tbl_line('4,12,22,10,8,18,6,6,16');
        -- Détail des comptes ouverts pour chaque institution religieuse flaggée
        DBMS_OUTPUT.PUT_LINE('');
        DBMS_OUTPUT.PUT_LINE('    Détail comptes ouverts :');
        FOR d IN (SELECT * FROM (
            SELECT c.CUSTOMER_NO,
    ...
    --      TAX_ID = FIELD_VAL_6 dans UDF (FUNCTION_ID='STDCIF')
    SELECT COUNT(*) INTO v_count FROM (
        SELECT c.CUSTOMER_NO
        FROM STTM_CUSTOMER c
        JOIN STTM_KYC_MASTER m ON m.KYC_REF_NO = c.KYC_REF_NO
        LEFT JOIN CSTM_FUNCTION_USERDEF_FIELDS u ON u.FUNCTION_ID = 'STDCIF' AND u.REC_KEY = c.CUSTOMER_NO || '~'
        WHERE c.CUSTOMER_NAME1 IS NOT NULL
          AND u.FIELD_VAL_6 IS NOT NULL
          AND TRIM(u.FIELD_VAL_6) IS NOT NULL
          AND m.RISK_LEVEL IS NOT NULL
          AND EXISTS (SELECT 1 FROM STTM_CUST_ACCOUNT a WHERE a.CUST_NO = c.CUSTOMER_NO AND a.RECORD_STAT = 'O')
          AND (UPPER(TRIM(c.CUSTOMER_NAME1)), UPPER(TRIM(u.FIELD_VAL_6))) IN (
              SELECT UPPER(TRIM(c2.CUSTOMER_NAME1)), UPPER(TRIM(u2.FIELD_VAL_6))
              FROM STTM_CUSTOMER c2
              JOIN STTM_KYC_MASTER m2 ON m2.KYC_REF_NO = c2.KYC_REF_NO
              LEFT JOIN CSTM_FUNCTION_USERDEF_FIELDS u2 ON u2.FUNCTION_ID = 'STDCIF' AND u2.REC_KEY = c2.CUSTOMER_NO || '~'
              WHERE c2.CUSTOMER_NAME1 IS NOT NULL
                AND u2.FIELD_VAL_6 IS NOT NULL
                AND TRIM(u2.FIELD_VAL_6) IS NOT NULL
                AND m2.RISK_LEVEL IS NOT NULL
                AND EXISTS (SELECT 1 FROM STTM_CUST_ACCOUNT a2 WHERE a2.CUST_NO = c2.CUSTOMER_NO AND a2.RECORD_STAT = 'O')
              GROUP BY UPPER(TRIM(c2.CUSTOMER_NAME1)), UPPER(TRIM(u2.FIELD_VAL_6))
              HAVING COUNT(DISTINCT c2.CUSTOMER_NO) > 1
                 AND COUNT(DISTINCT m2.RISK_LEVEL) > 1
          )
    );
    print_test('Clients multi-profils (même nom+TAX_ID) avec risk level différent', v_count);
    IF v_count > 0 THEN
        tbl_line('4,26,8,13,18,12,8,16');
        DBMS_OUTPUT.PUT_LINE('  |' || RPAD(' N#',4) || '|' || RPAD(' NOM CLIENT',26) || '|'
            || RPAD(' AGENCE',8) || '|' || RPAD(' CIF',13) || '|' || RPAD(' TAX_ID (NIF)',18) || '|'
        ...
        FOR d IN (SELECT * FROM (
            ...
            ORDER BY UPPER(TRIM(c.CUSTOMER_NAME1)), u.FIELD_VAL_6, m.RISK_LEVEL
        ) WHERE ROWNUM <= 60) LOOP
            v_row_num := v_row_num + 1;
            DBMS_OUTPUT.PUT_LINE('  |' || LPAD(v_row_num,3) || ' |'
    ...
    FROM STTM_CUSTOMER c
    WHERE c.CUSTOMER_TYPE = 'B'
      AND (c.SWIFT_CODE IS NULL OR TRIM(c.SWIFT_CODE) IS NULL)
      AND EXISTS (SELECT 1 FROM STTM_CUST_ACCOUNT a WHERE a.CUST_NO = c.CUSTOMER_NO AND a.RECORD_STAT = 'O');
    ...
    LEFT JOIN STTM_KYC_CORPORATE k ON k.KYC_REF_NO = m.KYC_REF_NO
    WHERE c.CUSTOMER_TYPE = 'B'
      AND k.KYC_NXT_REVIEW_DATE IS NOT NULL
      AND k.KYC_NXT_REVIEW_DATE < SYSDATE
      AND EXISTS (SELECT 1 FROM STTM_CUST_ACCOUNT a WHERE a.CUST_NO = c.CUSTOMER_NO AND a.RECORD_STAT = 'O');
    ...
    SELECT COUNT(*) INTO v_count
    FROM STTM_CUSTOMER c
    WHERE c.CUSTOMER_CATEGORY = 'BANK'
    ...
    SELECT COUNT(*) INTO v_count FROM (
        ...
        JOIN STTM_KYC_MASTER m ON m.KYC_REF_NO = c.KYC_REF_NO
        WHERE c.CUSTOMER_TYPE = 'B'
          AND c.CUST_CLASSIFICATION IS NOT NULL
          AND c.NATIONALITY IS NOT NULL
          AND m.RISK_LEVEL IS NOT NULL
          AND EXISTS (SELECT 1 FROM STTM_CUST_ACCOUNT a WHERE a.CUST_NO = c.CUSTOMER_NO AND a.RECORD_STAT = 'O')
          AND (NVL(c.NATIONALITY,'?'), NVL(c.CUST_CLASSIFICATION,'?')) IN (
              SELECT NVL(c2.NATIONALITY,'?'), NVL(c2.CUST_CLASSIFICATION,'?')
              FROM STTM_CUSTOMER c2
              JOIN STTM_KYC_MASTER m2 ON m2.KYC_REF_NO = c2.KYC_REF_NO
              WHERE c2.CUSTOMER_TYPE = 'B'
                AND c2.CUST_CLASSIFICATION IS NOT NULL
                AND c2.NATIONALITY IS NOT NULL
                AND m2.RISK_LEVEL IS NOT NULL
                AND EXISTS (SELECT 1 FROM STTM_CUST_ACCOUNT a2 WHERE a2.CUST_NO = c2.CUSTOMER_NO AND a2.RECORD_STAT = 'O')
              GROUP BY NVL(c2.NATIONALITY,'?'), NVL(c2.CUST_CLASSIFICATION,'?')
              HAVING COUNT(DISTINCT m2.RISK_LEVEL) > 1
          )
    );
    ...
    IF v_count > 0 THEN
        ...
        FOR d IN (SELECT * FROM (
            SELECT c.CUSTOMER_NO, NVL(c.CUSTOMER_NAME1,'-') AS nom,
                   NVL(c.CUST_CLASSIFICATION,'-') AS classif, NVL(m.RISK_LEVEL,'-') AS risk,
                   NVL(c.NATIONALITY,'-') AS nat,
                   NVL((SELECT SUM(a.ACY_CURR_BALANCE) FROM STTM_CUST_ACCOUNT a WHERE a.CUST_NO = c.CUSTOMER_NO AND a.RECORD_STAT = 'O'),0) AS total_solde
            FROM STTM_CUSTOMER c
            JOIN STTM_KYC_MASTER m ON m.KYC_REF_NO = c.KYC_REF_NO
            ...
            ORDER BY c.NATIONALITY, c.CUST_CLASSIFICATION, m.RISK_LEVEL,
                     NVL((SELECT SUM(a.ACY_CURR_BALANCE) FROM STTM_CUST_ACCOUNT a WHERE a.CUST_NO = c.CUSTOMER_NO AND a.RECORD_STAT = 'O'),0) DESC
